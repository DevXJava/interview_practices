...
public class SortMapByValues {
	...
	public static void main(String[] args) {
		...
		// ===================Third Way=================================
		Map<Integer, String> shortMapByValues = hashMap.entrySet().stream().sorted(Map.Entry.comparingByValue())
				.collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (v1, v2) -> v1, LinkedHashMap::new));
		map.forEach((k, v) -> System.out.println(k + "  :   " + v));

		// ==========================Short map by key===========================
		Map<Integer, String> shortMapByKeys = hashMap.entrySet().stream().sorted(Map.Entry.comparingByKey())
				.collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (v1, v2) -> v1, LinkedHashMap::new));
		map.forEach((k, v) -> System.out.println(k + "  :   " + v));
	}
